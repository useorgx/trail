...
export const CREDITS = [
  { id: 'clio', who: 'Alex Tamkin and the Clio team at Anthropic', work: 'Clio: privacy-preserving insights into real-world AI use', year: 2024,
    ...
    took: 'A fix’s public numbers appear only once at least 5 separate people have adopted it, and uploads carry counts, never words.',
  ...
  { id: 'error-analysis', who: 'Hamel Husain and Shreya Shankar', work: 'Error analysis for AI systems (open coding → axial coding → count → judge)', year: 2025,
    ...
    took: 'The walls are failure types counted across real sessions, and trail’s classifier is scored against human labels by true- and false-positive rate, not a single accuracy number.',
  ...
  { id: 'agent-trace', who: 'Cursor', work: 'Agent Trace: an open, vendor-neutral spec for AI code attribution', year: 2026,
    ...
    took: 'trail’s upload format (orgx-trail-threads/v1) is a short, documented contract any tool can produce.',
